...
<p class="row">
	<b><span>Latência de Resposta:</span></b>
...
<hr/>
<p><img src="<?php echo $urledit;?>"/> <?php echo CHtml::link("Editar essa verificação de prótese",array("proteseVerificacao/update","id" => $model->id),array('class' => 'botao'));?></p>