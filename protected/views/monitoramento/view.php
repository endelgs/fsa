...
<div>
	<div class='alinhamento'><h1>Dados de Monitoramento: <?php echo $model->pacienteR->nome; ?></h1></div>
	...
	<table style="width:800px;">
		...
		<tr>
			<td>
				<table>
					<tr>
						<td style="width:80px; text-align:right;">Dá tchau</td>
			...
			<td>
				<table>
					<tr>
						<td style="width:100px; text-align:right;">Cadê chupeta</td>
						<td><?php echo CHtml::encode($model->cade_chupeta); ?></td>
					</tr>
					<tr>
						<td style="width:80px; text-align:right;">Cadê mamãe</td>
						<td><?php echo CHtml::encode($model->cade_mamae); ?></td>
					</tr>
					<tr>
						<td style="width:80px; text-align:right;">Cadê sapato</td>
			...
			<td>
				<table>
					<tr>
						<td style="width:80px; text-align:right;">Cadê cabelo</td>
						<td><?php echo CHtml::encode($model->cade_cabelo); ?></td>
					</tr>
					<tr>
						<td style="width:80px; text-align:right;">Cadê mão</td>
						<td><?php echo CHtml::encode($model->cade_mao); ?></td>
					</tr>
					<tr>
						<td style="width:80px; text-align:right;">Cadê pé</td>
...
<p class="row">
	<b><span>Desenvolvimento de Linguagem:</span></b>
