...
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    <div class="row">
    	<div style="float:left; margin-right:12px;">
		     <?php echo $form->labelEx($model,'data_internacao'); ?>
		     <?php $this->widget('zii.widgets.jui.CJuiDatePicker', array(
			 	'attribute'=>'data_internacao',
			    'model' => $model,
			    'value'=>$model->data_nascimento,
			    'language'=>'pt-BR',
			    'options'=>array(
		     ...
		     <?php echo $form->error($model,'data_internacao'); ?>
	    </div>
	    <div>
	    	<?php echo $form->labelEx($model,'alta'); ?>
	    	<?php echo $form->radioButtonList($model,'alta',
	    			array(
	    				'alta'=>'Alta',
	    				'transferencia_interna'=>'Transferência Interna',
	    				'transferencia_externa'=>'Transferência Externa',
	    				'obito'=>'Óbito',
	    			), array('separator'=>'','labelOptions'=>array('style'=>'display:inline; line-height:30px; margin-right:10px;'))); ?>
