...
<div class="coluna">
	...
	<div class="row">
		Ganho de inserção método indireto:
	...
	<div class="row">
		<?php echo $form->labelEx($model,'estagio_desenvolvimento'); ?>
		<?php echo $form->textArea($model,'estagio_desenvolvimento',array('rows'=>6, 'cols'=>60)); ?>
		<?php echo $form->error($model,'estagio_desenvolvimento'); ?>
	</div>
</div>
	<div class="row buttons">
		...
		<?php 
			if($model->isNewRecord ){
				echo CHtml::submitButton('Inserir e Ir para Anexo',array('submit'=>Yii::app()->controller->createUrl('proteseValidacao/createProximoForm')));
			}
		?>
	</div>
