...
class ProteseAnexo extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			'id' => 'ID',
			'comportamento_vocal' => '01 - O comportamento vocal da criança é modificado é modificado quando está usando o seu dispositivo auditivo (AASI ou implante Coclear) ?',
			...
			'silabas_articuladas' => '02 - A criança produz silabas bem articuladas e sequências silábicas que podem ser reconhecidas como fala? (Ex. mamama,bababa...)',
			...
			'emite_sons' => '',
			'resposta_primeira_chamada' => '03 - Se você chamou a criança por trás, numa sala silenciosa, sem pista visual, com que frequência ela responde à primeira chamada (para de brincar, olha para cima ou ao redor, cessa o choro ou sucção da chupeta..)? Cite exemplos.',
			...
			'resposta_chamada_ruido' => '04 - Se vocẽ chamou a criança por trás, num ambiente ruidoso, como uma sala com pessoas conversando, crianças bricando ou com televisão ligada, sem pista visual, em que porcentagem ela responde à primeira chamada? Cite exemplos',
			...
			'sons_ambientais' => '05 - Cite exemplos de sons ambientais que a criança responde em casa ou em situações familiares (restaurantes, lojas, parques infantis...) Ex: telefone, campanhia, cachorro, alarme...',
			...
			'curiosidade_novos_sons' => '06 - A criança mostra curiosidade (verbalmente ou não) para novos sons, quando em locais não familiares, tais como lojas, restaurantes, outras casa...? Ex. sinos, alarmes, choros, risos..',
			'atencao_espontanea_sinais_auditivos' => 'A criança está atenta, espontaneamente, aos sinais auditivos, quando em novos ambientes?',
			'reconhece_sinais_auditivos' => '07 - A criança reconhece regularmente, ou responde adequadamente aos sinais auditivos que ocorrem na creche, pré-escola ou em casa, sem pistas visuais ou alerta? Ex: olhar para fonte sonora quando ocorre o barulho.',
			...
			'diferenciar_vozes' => '08 - A criança pode diferenciar duas vozes prontamente? Se está brincando com dois irmãos e um deles fala alguma coisa, ela olha em sua direção corretamente?',
			...
			'reconhece_fala_sons_nao_verbais' => '09 - A criança reconhece o som da fala de outros sons não verbais? Por exemplo, se você está na sala junto com a criança e a chama, ela olha para você ou para o brinquedo?',
			...
			'emocao_voz_pessoa' => '10 - Somente através da audição a criança pode perceber a emoção inerente á voz de alguma pessoa, assim como uma voz brava, excitada, etc..? Exemplos, a mãe grita, e a criança chora assustada.',
