...
/**
 * This is the model class for table "protese_validacao".
 *
 ...
 */
class ProteseValidacao extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return ProteseValidacao the static model class
	 */
